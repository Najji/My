...
<script src="http://ajax.googleapis.com/ajax/libs/jquery/1.7.1/jquery.min.js" type="text/javascript"></script>
	...
	<body>
        ...
        <br>
    <canvas id="canvas" width="450" height="450" style="background: #eee""></canvas>  
        <br>
		<script src="/js/arcade/game1.js" type="text/javascript"></script>
        &nbsp
        Instructions : <br>
        ...
        <a href="/arcade/game1/highScores">Go to High Scores</a>          
	</body>
</html>